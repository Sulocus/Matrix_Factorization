...
def tensor_step_super(
    ...
    for d in range(n):
        ...
        # tau contribution - TeS-AMP MATCH: use squared means only (not second moments)
        # Reference: tes_amp.py L103-105 uses Z_hat²  only, NOT (Z_hat² + Z_var)
        # The previous "N-GAMP FIX" was incorrect for this algorithm.
        if n > 1:
