...
def get_metric_specs() -> Dict[str, MetricSpec]:
    specs = [
        MetricSpec("matrix.full.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher"], ["Q_Y_mean", "Q_Y_std", "NMSE_Y_mean", "NMSE_Y_std", "Q_Y_PROJ_ABS_mean", "Q_Y_PROJ_ABS_std"], "measurement", "full", "teacher-student", "fit_nmse_plus_legacy_projection", "Dense matrix full-output FIT=1-NMSE plus legacy absolute projection.", ["agd", "bigamp"]),
        MetricSpec("matrix.observed.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher", "mask"], ["Q_Y_observed_mean", "Q_Y_observed_std", "NMSE_Y_observed_mean", "NMSE_Y_observed_std", "Q_Y_observed_PROJ_ABS_mean", "Q_Y_observed_PROJ_ABS_std"], "measurement", "observed", "teacher-student", "fit_nmse_plus_legacy_projection", "Dense observed-entry output FIT=1-NMSE plus legacy projection.", ["agd", "bigamp"]),
        MetricSpec("matrix.unobserved.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher", "mask"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std", "NMSE_Y_unobserved_mean", "NMSE_Y_unobserved_std", "Q_Y_unobserved_PROJ_ABS_mean", "Q_Y_unobserved_PROJ_ABS_std"], "measurement", "unobserved", "teacher-student", "fit_nmse_plus_legacy_projection", "Dense unobserved-entry output FIT=1-NMSE plus legacy projection.", ["agd", "bigamp"]),
        MetricSpec("spreading.full.Q_Y", ["W_students", "X_students", "spreading_graph", "F_super", "heldout_F"], ["Q_Y_mean", "Q_Y_std", "NMSE_Y_mean", "NMSE_Y_std", "Q_Y_PROJ_ABS_mean", "Q_Y_PROJ_ABS_std"], "measurement", "full", "teacher-student", "fit_nmse_plus_legacy_projection", "Observed + deterministic heldout F-aware graph FIT=1-NMSE plus legacy projection.", ["bigamp_spreading"]),
        MetricSpec("spreading.observed.Q_Y", ["W_students", "X_students", "spreading_graph", "F_super", "Y_super"], ["Q_Y_observed_mean", "Q_Y_observed_std", "NMSE_Y_observed_mean", "NMSE_Y_observed_std", "Q_Y_observed_PROJ_ABS_mean", "Q_Y_observed_PROJ_ABS_std"], "measurement", "observed", "teacher-student", "fit_nmse_plus_legacy_projection", "Observed spreading graph FIT=1-NMSE using the same F plus legacy projection.", ["bigamp_spreading", "agd_spreading"]),
        MetricSpec("spreading.unobserved.Q_Y", ["W_students", "X_students", "heldout_spreading_graph", "heldout_F"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std", "NMSE_Y_unobserved_mean", "NMSE_Y_unobserved_std", "Q_Y_unobserved_PROJ_ABS_mean", "Q_Y_unobserved_PROJ_ABS_std"], "measurement", "unobserved", "teacher-student", "fit_nmse_plus_legacy_projection", "Deterministic heldout F-aware graph FIT=1-NMSE plus legacy projection.", ["bigamp_spreading"]),
        MetricSpec("tensor.full.Q_Y", ["tensor_observations", "tensor_heldout_observations"], ["Q_Y_mean", "Q_Y_std", "NMSE_Y_mean", "NMSE_Y_std", "Q_Y_PROJ_ABS_mean", "Q_Y_PROJ_ABS_std"], "measurement", "full", "teacher-student", "fit_nmse_plus_legacy_projection", "Observed + deterministic heldout tensor-hyperedge FIT=1-NMSE plus legacy projection.", ["bigamp_tensor_parallel"]),
        MetricSpec("tensor.serial_observed.Q_Y", ["tensor_observations"], ["Q_Y_mean", "Q_Y_std", "Q_Y_observed_mean", "Q_Y_observed_std", "NMSE_Y_mean", "NMSE_Y_std", "NMSE_Y_observed_mean", "NMSE_Y_observed_std", "Q_Y_PROJ_ABS_mean", "Q_Y_PROJ_ABS_std", "Q_Y_observed_PROJ_ABS_mean", "Q_Y_observed_PROJ_ABS_std"], "measurement", "observed", "teacher-student", "fit_nmse_plus_legacy_projection", "Serial tensor observed-hyperedge FIT=1-NMSE stored under Q_Y flat keys plus legacy projection.", ["bigamp_tensor"]),
        MetricSpec("tensor.observed.Q_Y", ["tensor_observations"], ["Q_Y_observed_mean", "Q_Y_observed_std", "NMSE_Y_observed_mean", "NMSE_Y_observed_std", "Q_Y_observed_PROJ_ABS_mean", "Q_Y_observed_PROJ_ABS_std"], "measurement", "observed", "teacher-student", "fit_nmse_plus_legacy_projection", "Observed tensor-hyperedge FIT=1-NMSE plus legacy projection.", ["bigamp_tensor_parallel", "agd_tensor"]),
        MetricSpec("tensor.unobserved.Q_Y", ["tensor_heldout_observations"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std", "NMSE_Y_unobserved_mean", "NMSE_Y_unobserved_std", "Q_Y_unobserved_PROJ_ABS_mean", "Q_Y_unobserved_PROJ_ABS_std"], "measurement", "unobserved", "teacher-student", "fit_nmse_plus_legacy_projection", "Deterministic heldout tensor-hyperedge FIT=1-NMSE plus legacy projection.", ["bigamp_tensor_parallel"]),
...
def get_metric_semantic_classes() -> Dict[str, MetricSemanticClass]:
    ...
    classes = [
        MetricSemanticClass(
            ...
            "medium",
            "approved",
            description="Output/measurement reconstruction fit 1-NMSE on the full configured evaluation set.",
        ),
        MetricSemanticClass(
            "measurement.observed.teacher_student.Q_Y_fit",
            "measurement_fit",
            "Q_Y observed FIT=1-NMSE",
            ...
            "medium",
            "approved",
            description="Output/measurement reconstruction fit restricted to observed/training measurements.",
        ),
        MetricSemanticClass(
            "measurement.unobserved.teacher_student.Q_Y_fit",
            "measurement_fit",
            "Q_Y unobserved FIT=1-NMSE",
            ...
            "medium",
            "approved",
            description="Output/measurement reconstruction fit on heldout or unobserved measurements.",
        ),
        MetricSemanticClass(
...
def _attach_metric_semantic_metadata(specs: List[MetricSpec]) -> List[MetricSpec]:
    mapping = {
        "matrix.full.Q_Y": "measurement.full.teacher_student.Q_Y_fit",
        "matrix.observed.Q_Y": "measurement.observed.teacher_student.Q_Y_fit",
        "matrix.unobserved.Q_Y": "measurement.unobserved.teacher_student.Q_Y_fit",
        "spreading.full.Q_Y": "measurement.full.teacher_student.Q_Y_fit",
        "spreading.observed.Q_Y": "measurement.observed.teacher_student.Q_Y_fit",
        "spreading.unobserved.Q_Y": "measurement.unobserved.teacher_student.Q_Y_fit",
        "tensor.full.Q_Y": "measurement.full.teacher_student.Q_Y_fit",
        "tensor.serial_observed.Q_Y": "measurement.observed.teacher_student.Q_Y_fit",
        "tensor.observed.Q_Y": "measurement.observed.teacher_student.Q_Y_fit",
        "tensor.unobserved.Q_Y": "measurement.unobserved.teacher_student.Q_Y_fit",
