...
def get_metric_specs() -> Dict[str, MetricSpec]:
    specs = [
        ...
        MetricSpec("spreading.full.Q_Y", ["W_students", "X_students", "spreading_graph", "F_super", "heldout_F"], ["Q_Y_mean", "Q_Y_std", "FIT_Y_mean", "FIT_Y_std", "NMSE_Y_mean", "NMSE_Y_std", "Q_Y_PROJ_ABS_mean", "Q_Y_PROJ_ABS_std"], "measurement", "full", "teacher-student", "projection_plus_fit_nmse", "Observed + deterministic heldout F-aware graph Q_Y projection plus FIT=1-NMSE diagnostic.", ["bigamp_spreading"]),
        ...
        MetricSpec("spreading.unobserved.Q_Y", ["W_students", "X_students", "heldout_spreading_graph", "heldout_F"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std", "FIT_Y_unobserved_mean", "FIT_Y_unobserved_std", "NMSE_Y_unobserved_mean", "NMSE_Y_unobserved_std", "Q_Y_unobserved_PROJ_ABS_mean", "Q_Y_unobserved_PROJ_ABS_std"], "measurement", "unobserved", "teacher-student", "projection_plus_fit_nmse", "Deterministic heldout F-aware graph Q_Y projection plus FIT=1-NMSE diagnostic.", ["bigamp_spreading"]),
