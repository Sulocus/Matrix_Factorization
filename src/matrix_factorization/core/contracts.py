...
def get_metric_specs() -> Dict[str, MetricSpec]:
    specs = [
        MetricSpec("matrix.full.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher"], ["Q_Y_mean", "Q_Y_std"], "measurement", "full", "teacher-student", "absolute_projection_teacher_norm_squared", "Dense matrix full-output absolute projection.", ["agd", "bigamp"]),
        MetricSpec("matrix.observed.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher", "mask"], ["Q_Y_observed_mean", "Q_Y_observed_std"], "measurement", "observed", "teacher-student", "absolute_projection_teacher_norm_squared", "Dense observed-entry output projection.", ["agd", "bigamp"]),
        MetricSpec("matrix.unobserved.Q_Y", ["W_students", "X_students", "W_teacher", "X_teacher", "mask"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std"], "measurement", "unobserved", "teacher-student", "absolute_projection_teacher_norm_squared", "Dense unobserved-entry output projection.", ["agd", "bigamp"]),
        MetricSpec("spreading.full.Q_Y", ["W_students", "X_students", "spreading_graph", "F_super", "heldout_F"], ["Q_Y_mean", "Q_Y_std"], "measurement", "full", "teacher-student", "absolute_projection_teacher_norm_squared", "Observed + deterministic heldout F-aware graph projection.", ["bigamp_spreading"]),
        MetricSpec("spreading.observed.Q_Y", ["W_students", "X_students", "spreading_graph", "F_super", "Y_super"], ["Q_Y_observed_mean", "Q_Y_observed_std"], "measurement", "observed", "teacher-student", "absolute_projection_teacher_norm_squared", "Observed spreading graph projection using the same F.", ["bigamp_spreading", "agd_spreading"]),
        MetricSpec("spreading.unobserved.Q_Y", ["W_students", "X_students", "heldout_spreading_graph", "heldout_F"], ["Q_Y_unobserved_mean", "Q_Y_unobserved_std"], "measurement", "unobserved", "teacher-student", "absolute_projection_teacher_norm_squared", "Deterministic heldout F-aware graph projection.", ["bigamp_spreading"]),
        MetricSpec("tensor.full.Q_Y", ["tensor_observations", "tensor_heldout_observations"], ["Q_Y_mean", "Q_Y_std"], "measurement", "full", "teacher-student", "absolute_projection_teacher_norm_squared", "Observed + deterministic heldout tensor-hyperedge projection.", ["bigamp_tensor_parallel"]),
        ...
        MetricSpec("matrix.factor.Q_W", ["W_students", "W_teacher"], ["Q_W_mean", "Q_W_std", "Q_W_SIGN_ALIGNED_mean", "Q_W_SIGN_ALIGNED_std", "Q_W_COS_ROOT_mean", "Q_W_COS_ROOT_std"], "latent_factor", "full", "teacher-student", "absolute_projection_sign_aligned_and_cos_root", "W coordinate projection plus sign-aligned and Cos-root diagnostics.", ["agd", "bigamp", "bigamp_spreading", "agd_spreading"]),
        MetricSpec("matrix.factor.Q_X", ["X_students", "X_teacher"], ["Q_X_mean", "Q_X_std", "Q_X_SIGN_ALIGNED_mean", "Q_X_SIGN_ALIGNED_std", "Q_X_COS_ROOT_mean", "Q_X_COS_ROOT_std"], "latent_factor", "full", "teacher-student", "absolute_projection_sign_aligned_and_cos_root", "X coordinate projection plus sign-aligned and Cos-root diagnostics.", ["agd", "bigamp", "bigamp_spreading"]),
...
def get_metric_semantic_classes() -> Dict[str, MetricSemanticClass]:
    ...
    classes = [
        MetricSemanticClass(
            ...
            "medium",
            "approved",
            description="Output/measurement absolute projection |<Y_s,Y_t>|/<Y_t,Y_t> on the full configured evaluation set.",
        ),
        MetricSemanticClass(
        ...
        MetricSemanticClass(
            ...
            "latent_factor_projection",
            "Q_W coordinate projection",
            ["Q_W_mean", "Q_W_std"],
            "latent_factor",
            "full",
            "teacher-student",
            ...
            "high",
            "approved",
            description="W latent factor absolute coordinate projection; gauge/rotation sensitive.",
        ),
        MetricSemanticClass(
            "latent.X.teacher_student.Q_X_projection",
            "latent_factor_projection",
            "Q_X coordinate projection",
            ["Q_X_mean", "Q_X_std"],
            "latent_factor",
            "full",
            "teacher-student",
            ...
            "high",
            "approved",
            description="X latent factor absolute coordinate projection; gauge/rotation sensitive.",
        ),
        MetricSemanticClass(
        ...
        MetricSemanticClass(
            ...
            "high",
            "approved",
            description="Tensor latent node/spin/factor absolute coordinate projection, per mode and averaged across modes.",
        ),
        MetricSemanticClass(
