...
def run_in_background(config: Config, log_file: str = None) -> str:
    ...
    # Build nohup command
    cmd = f'nohup python -c "from MF.runner import run_experiment; from MF.core.config import Config; c = Config.from_json(\\\"{config_file}\\\"); run_experiment(c)" > {log_file} 2>&1 &'
