...
Located in `MF/modules/algorithms/bigamp_spreading.py`
...
- `MF/modules/teachers/random_spreading.py` - Core implementation
- `MF/modules/algorithms/bigamp_spreading.py` - BiG-AMP algorithm for spreading
- `MF/modules/metrics/spreading.py` - Q_Y evaluation for spreading
